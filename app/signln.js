// Importa componentes do React Native para estrutura a interface e interatividade
import { View, Text, Image, TextInput, TouchableOpacity, Pressable, Alert} from 'react-native'
// Importa React, hooks de estado e referência para gerenciar os inputs e estado de carregamento
import React, { useRed, useState } from 'react'
// Importa funções para criar layouts responsivos com base no tamanhon da tela
...
// Importa ícones do pacote expo, como o ícone de email e o cadeado para o input de senha
...
export default function SignIn() {
    ...
    return (
        ...
        <CustomKeyboardView>
            ...
            <SstatusBar style="dark" />
            <View style={{paddingTop: hp(8), paddingHorizontal: wp(5)}} className="flex-1 gap-12">
                {/* Exibe uma imagem d elogin no topo da tela*/}
                <View className="items-center">
                    <Image style={{height: hp(25)}} reziseMode='contain' source={require('../assets/images/login.png')} />
                </View>
                    ...
                    <View className="gap-4">
                        ...
                        <View style={{height: hp(7)}} className="flex-row gap-4 px-4 bg-neutral-100 items-center rounded-x1">
                            ...
                            <TextInput
                                ...
                                style={{fontSize: hp(2)}}
                                className="fkex-1 font-semibold text-neutral-700"
                                placeholder='E-mail'
